...
-- INSERT Banco (CodBanco, DescBanco, WebSite) VALUES ('105', 'Caixa Ecônomica Federal', 'www.caixa.gov.br')

SELECT BancoId, CodBanco, DescBanco, WebSite FROM Banco WHERE BancoId =: BancoId;