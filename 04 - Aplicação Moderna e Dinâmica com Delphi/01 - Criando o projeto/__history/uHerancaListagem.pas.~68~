...
begin
  ...
  begin
    MessageDlg('Não existe Introdução SQL no Componente',
  ...
  { Adicionando valor a variável "sIndexFieldNames" que vai ser chamado dentro do
	  método "MudarCorGridIndice" }
