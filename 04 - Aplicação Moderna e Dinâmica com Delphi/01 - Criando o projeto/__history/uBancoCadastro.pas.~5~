...
type
  TfrmBancoCadastro = class(TfrmHerancaCadastro)
    QryCadastroBancoId: TZIntegerField;
    QryCadastroCodBanco: TZUnicodeStringField;
    QryCadastroDescBanco: TZUnicodeStringField;
    QryCadastroWebSite: TZUnicodeStringField;
    Label1: TLabel;
    DBEdit1: TDBEdit;
    Label2: TLabel;
    DBEdit2: TDBEdit;
